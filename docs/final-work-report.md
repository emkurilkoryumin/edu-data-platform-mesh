...
Дата итоговой проверки: 28 мая 2026.
...
Они генерируют воспроизводимые синтетические данные для кейса галереи, валидируют их и
записывают в Raw-слой. Происхождение и ограничения данных отдельно описаны в
